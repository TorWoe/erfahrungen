        ...
        if (state.tips.length === 0) {
            state.tips = [
                ...
                },
                {
                    ...
                    number: 8,
                    text: ">> Worum geht es in diesem Tipp <<\nDer Bereich \"Suche\" hilft Dir, gezielt einzelne Erfahrungen zu finden und Dich auf das Wesentliche zu konzentrieren. Hier erfährst Du, welche Suchmöglichkeiten Dir zur Verfügung stehen – ideal, um regelmäßig mit Deinen Erfahrungen zu arbeiten.\n\n\n💡 \"Ja, dauerhafte positive Stärke aufzubauen erfordert ein bisschen Arbeit – aber eine bessere Arbeit kann es kaum geben.\"\nNimm Dir von Zeit zu Zeit in einer ruhigen Minute Deine Erfahrungen mit den positiven Erkenntnissen und Antworten vor. Das hilft Dir, Deine innere Stärke aufzubauen, sie zu bewahren und zu einem festen Teil von Dir zu machen – gerade dann, wenn es mal schwierig wird.\n\nDer Bereich \"Suche\" eignet sich dafür besonders gut.\n\n*) Gezielt suchen und sich auf das Wesentliche konzentrieren\nHier kannst Du Deine Erfahrungen eingrenzen, damit Du Dich ganz auf das konzentrieren kannst, was Dich gerade beschäftigt – ohne von weiteren Erfahrungen abgelenkt zu werden.\n\nFolgende Suchmöglichkeiten stehen Dir zur Verfügung:\n- Textsuche – suche nach bestimmten Worten bzw. einem von Dir eingegebenen Text oder suche nach von Dir vergebenen Tags\n- Inhaltliche Auswahl – lasse Dir Deine Erfahrungen zu einer oder mehreren \"Bezugspersonen / Bezugsobjekten\", \"primären Auslösern\" oder \"Triggern\" anzeigen\n- Alle Erfahrungen – zeige Dir auf Wunsch auch alle Deine Erfahrungen auf einmal an\n\nFür eine neue Suche klicke einfach auf \"Reset\" und starte von vorne.\n\n*) Dir fällt beim Lesen etwas auf?\nWenn Du beim Durchsehen Deiner Erfahrungen etwas ändern oder anpassen möchtest – oder Dir eine neue wichtige Erkenntnis oder Antwort einfällt – wechsle einfach in den Bereich \"Einträge\" und bearbeite dort die jeweilige Erfahrung. Mit Vorgabe des Tagesdatums zu der Erfahrung, die Du ändern oder erweitern möchtest, kommst Du direkt zu der richtigen und gewünschten Erfahrung.\n\nsiehe hierzu auch die Tipps:\n➜ \"Wie werden Erfahrungen in der Web-App eingegeben?\"\n➜ \"Wie werden Erkenntnisse / Antworten in der Web-App eingegeben?\"\n➜ \"Wofür ist der Bereich Einträge?\"",
                    tags: [],
                    timestamp: new Date().toISOString(),
                },
                {
                    id: uid(),
                    title: "Wofür ist der Bereich 'Einstellungen'",
                    number: 9,
                    text: ">> Worum geht es in diesem Tipp <<\nHier richtest Du das Grundgerüst für Deine Erfahrungen ein, sicherst Deine Daten und verwaltest Deine eigenen Tipps. \nBesonders wichtig: Erfahre, wo Deine Daten liegen und warum regelmäßige Backups so wichtig sind.\n\n\nDer Bereich \"Einstellungen\" ist so etwas wie das zentrale Steuerungssystem der Erfahrungen Web-App. Hier wirst Du nur von Zeit zu Zeit arbeiten – z. B. um das Grundgerüst für Deine Erfahrungen einzurichten, Deine Daten zu sichern oder an Deinen Tipps zu arbeiten.\n\n💡 Wichtig zu wissen – Wo liegen Deine Daten?\nDie Erfahrungen Web-App ist erst einmal keine vollständige Serverversion. Das bedeutet für Dich:\nAlle von Dir eingegebenen Daten – also Deine Erfahrungen, Einstellungen und eigenen Tipps – liegen ausschließlich lokal auf Deiner Hardware (Computer, Tablet, Smartphone) und dort auch nur in dem Browser, den Du nutzt (Chrome, Edge, Firefox, Opera usw.). Genauer gesagt werden sie im sogenannten Browsercache gespeichert.\n\n⚠️ Achtung: Wenn Du in Deinem Browser die Browserdaten löschst, werden automatisch auch alle Deine eingegebenen Daten gelöscht!\n\n!!! Erstelle deshalb regelmäßig ein Backup! Das machst Du hier im Bereich \"Einstellungen\" – es dauert nur wenige Sekunden. Dein Backup kannst Du bei Bedarf jederzeit wieder importieren und hast so alle Deine Daten sofort zurück.\n\n1) Daten\n*) Der Button \"Backup\"\nMit einem Klick erstellst Du eine Sicherungsdatei (eine JSON-Datei), die lokal auf Deiner Hardware gespeichert wird – meist im Verzeichnis \"Downloads\", sofern Du kein anderes Verzeichnis gewählt hast.\nDie Datei hat immer diesen Aufbau: erfahrungen_backup_2026-03-27_11-53-06.json – das Datum und die Uhrzeit zeigen Dir, wann Du das Backup erstellt hast. So findest Du immer schnell Dein letztes und aktuelles Backup.\n\n*) Der Button \"Daten importieren\"\nMit einem Klick kannst Du Deine Backup-Datei auswählen und in die App laden. Alle von Dir eingegebenen Daten – Erfahrungen, Einstellungen und Tipps – werden damit wiederhergestellt.\n\n*) Der Button \"Alle Daten löschen\"\nMöchtest Du alle Deine eingegebenen Daten auf einmal löschen, kannst Du das hiermit tun. Du brauchst dafür nicht in Deinem Browser die Funktion \"Browserdaten löschen\" auszuführen.\n\n💡Bedenke auch hier: Deine Daten liegen nur lokal auf Deiner Hardware und nur in dem Browser, den Du nutzt.\n\n\n2) Bezugsperson / Bezugsobjekt, primärer Auslöser, meine Trigger\n💡 Diese drei Punkte helfen Dir, \n- Deine Erfahrungen strukturiert einzugeben, \n- in den Bereichen \"Einträge\" und \"Suche\" klar auszuwählen und gezielt zu betrachten, \n- um Dich damit auseinanderzusetzen.\n\n*) Bezugsperson / Bezugsobjekt – \"Um wen oder was geht es im Wesentlichen?\"\nHier benennst Du die Person, die Gruppe, das Lebewesen oder das Objekt, um das es bei Deiner Erfahrung im Kern geht. \nDie Antwort ist immer ein Hauptwort – kein Gefühl, kein Zustand und keine Tätigkeit. \nNimm Dir einen Moment Zeit und versuche, einen möglichst treffenden und umfassenden Begriff zu finden. Je besser der Begriff gewählt ist, desto hilfreicher wird er für Dich sein.\n\n*) Primärer Auslöser – \"Was macht das mit mir?\"\nFrage Dich: \"Was löst die Bezugsperson oder das Bezugsobjekt in mir aus?\" oder \"Welche Gefühle habe ich dabei?\" \nDie Antwort ist hier ein Gefühl, ein Zustand oder eine Eigenschaft – also das, was die Wirkung auf Dich beschreibt. Es kann auch mehrere Auslöser geben, konzentriere Dich aber auf die wirklich wichtigen und vermeide Doppelungen.\n\n*) Meine Trigger – \"Was wird in mir unbewusst ausgelöst?\"\nTrigger sind meist unbewusste Muster in Dir, die durch bestimmte Situationen aktiviert werden. Sie werden häufig im Rahmen einer Therapie z.B. gemeinsam mit einem Psychotherapeuten erarbeitet. Wenn Du die App nicht im Rahmen einer Therapie nutzt, kannst Du diesen Punkt einfach leer lassen.\n\n➜ siehe hierzu auch den Tipp: \"Wie werden gute Einträge zu Bezugsperson / Bezugsobjekt, primärer Auslöser und meine Trigger formuliert?\"\n\n\n3) Tipps\nHier kannst Du eigene Tipps oder Merksätze eingeben – so hast Du alles Wichtige an einem Ort und musst Dir nicht alles merken, was Du Dir immer mal wieder in Erinnerung rufen möchtest.\n\n*) Überschrift – Gib Deinem Tipp eine kurze und aussagekräftige Überschrift.\n\n*) Nummer – Die Eingabe einer Nummer ist nicht erforderlich. Ohne Nummerierung werden Deine Tipps einfach in der Reihenfolge angezeigt, in der Du sie eingegeben hast. Tipps mit einer Nummer stehen dabei immer vor Tipps ohne Nummer.\n\nÜber das Nummernfeld kannst Du die Reihenfolge aller Tipps ändern – sowohl Deiner eigenen als auch der bereits vorhandenen Tipps in der Erfahrungen Web-App. \nDie kleinste Nummer steht dabei immer oben. Das ist besonders praktisch, damit Du Dir die wichtigsten Tipps ganz nach oben sortieren kannst und ein längeres Scrollen vermeidest. \nVermeide dabei doppelte Nummern und baue Dir lieber einmal in Ruhe die Reihenfolge auf, die für Dich am besten passt.\n\n*) Tags – Allen Tipps kannst Du frei wählbare Stichworte hinzufügen. Sie helfen Dir später beim Suchen nach bestimmten Tipps.\n\n*) Text / Beschreibung – In diesem Feld gibst Du den eigentlichen Inhalt Deines Tipps ein.\n\n*) Tipps bearbeiten und löschen\nNeben der Eingabe neuer Tipps kannst Du hier auch alle vorhandenen Tipps ändern oder löschen.\n\n💡 Ein kleiner Rat: Bevor Du einen Tipp löschst, sortiere ihn erst einmal mit einer hohen Nummer ganz ans Ende. Oft greift man später doch noch gerne auf den einen oder anderen Tipp zurück.",
                    tags: [],
                    timestamp: new Date().toISOString(),
                },
                {
                ...
                {
                    id: uid(),
                    title: "Der Schlüssel ist das gezielte Auswählen und Sortieren Deiner Erfahrungen und Erkenntnisse / Antworten",
                    number: 11,
                    text: ">> Worum geht es in diesem Tipp <<\nErfahre, wie Du durch gezieltes Auswählen und Sortieren Deiner Erfahrungen genau die positiven Erkenntnisse findest, die zu Deiner aktuellen Situation passen. Denn der Schlüssel liegt nicht darin, alles auf einmal zu betrachten, sondern das Richtige zur richtigen Zeit.\n\n\nUm positives Denken, gutes Selbstvertrauen und die Kraft zum Handeln aufzubauen, hilft es sehr, Dich bewusst mit dem zu beschäftigen, was Du alles schon Positives erreicht hast. Nicht umsonst sagt man: \"Aus Erfolgen lernt man\" und \"Erfolg motiviert\".\n\n💡 Dabei ist eines besonders wichtig: Schau Dir nicht einfach alle Deine Erfahrungen auf einmal an, sondern wähle gezielt die aus, die zu Deiner aktuellen Situation passen oder ihr nahekommen.\n\n>> Das gezielte Auswählen\nIm Bereich \"Suche\" stehen Dir dafür folgende Möglichkeiten zur Verfügung:\n\n* Textsuche – suche nach bestimmten Worten bzw. einem von Dir eingegebenen Text oder suche nach von Dir vergebenen Tags\n* Inhaltliche Auswahl – lasse Dir Deine Erfahrungen zu einer oder mehreren \"Bezugspersonen / Bezugsobjekten\", \"primären Auslösern\" oder \"Triggern\" anzeigen\n* Alle Erfahrungen – zeige Dir auf Wunsch auch alle Deine Erfahrungen auf einmal an\n\n💡 Besonders wirkungsvoll ist die inhaltliche Auswahl: Wähle die Kriterien, die Deiner aktuellen Situation am besten entsprechen, und beschäftige Dich gezielt mit den dazu passenden Erfahrungen und den positiven Erkenntnissen, die Du bereits gewonnen hast.\nOft helfen Dir für eine gute Auswahl anstatt der inhaltlichen Kriterien auch die von Dir eingegebenen Tags - diese gibst Du in dem Feld für die Textsuche ein.\n\nSpiele ruhig ein bisschen mit den verschiedenen Auswahlkriterien – so findest Du die Erfahrungen, die gerade am besten zu Dir und Deiner Situation passen.\n\n>> Das richtige Sortieren\nDeine Erfahrungen werden grundsätzlich in der Reihenfolge angezeigt, in der Du sie eingegeben hast – das spiegelt ein Stück weit Deinen persönlichen Weg wider.\n\nManchmal möchtest Du aber die Reihenfolge der ausgewählten Erfahrungen verändern, weil es Dir so leichter fällt, Dich damit zu beschäftigen. Das geht ganz einfach:\n\n1. Überlege Dir zuerst, in welcher Reihenfolge Du die ausgewählten Erfahrungen sehen möchtest.\n2. Wechsle in den Bereich \"Einträge\" und wähle das Tagesdatum der Erfahrung aus, die unten stehen soll.\n3. Klicke bei dieser Erfahrung auf \"Bearbeiten\" und danach direkt auf \"Speichern\". Dadurch wird der interne Zeitstempel für die Sortierung aktualisiert.\n4. Wiederhole dies für die nächste Erfahrung, die Du neu positionieren möchtest.\n\nDie Erfahrung, die Du zuletzt gespeichert hast, steht anschließend ganz oben – die davor gespeicherte an zweiter Stelle, und so weiter.\n\nDas Ändern der Reihenfolge ist dabei schon ein Teil Deiner aktiven Beschäftigung mit Deinen Erfahrungen.\n\n💡 Die Reihenfolge ist nichts Festes. Immer wenn Du für Deine aktuelle Situation die passenden Erfahrungen auswählst, prüfe auch, ob Du die Reihenfolge anpassen möchtest – passend zu dem, was Dich gerade bewegt.\n\n💡 Wie Du weißt, \"dauerhafte positive Stärke aufzubauen erfordert ein bisschen Arbeit – aber eine bessere Arbeit kann es kaum geben.\"",
                    tags: [],
                    timestamp: new Date().toISOString(),
                },
            ];
